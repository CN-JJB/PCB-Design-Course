...
# 2.9 两块真实四层板：为什么“能做四层”不等于“应该照抄”

Reddit 第二批里还有两个很适合当课堂样本的真实四层描述：

### 样本 A：nRF52840 wearable

~~~text
Top / GND / 3V3 / Bottom
~~~

但天线区域四层全部 keepout。说明“完整 GND”在 RF boundary 前必须服从器件天线要求。

### 样本 B：STM32H7 + sensors

~~~text
Top / GND / PWR / Bottom
~~~

其中 PWR layer 主要是 3.3 V，但板边还有 5 V rail。

这正好说明：

> **Power plane 可以按 rail 分区，并不等于 Ground plane 也应该照着分。**

### 课堂任务

拿到任何别人成功打样的四层板，先不要问“能不能抄 stackup”。先填：

| 问题 | 你的答案 |
|---|---|
| 它的高速接口是什么？ | |
| 哪些网络走 bottom？ | |
| bottom reference 是否连续？ | |
| power split 有没有被高速线跨越？ | |
| RF / isolation keepout 是否破坏 reference？ | |
| 它的成功能否迁移到我的器件？ | |

只要这张表答不完，这个案例就只能叫 **参考样本**，不能叫设计依据。
