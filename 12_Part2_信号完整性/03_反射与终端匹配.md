...
## 3.6.1 Termination 跟着系统 Z0 走，不是永远围绕 50 Ω

如果一个系统从 architecture 层就选择：
...
那么 termination 的目标也必须围绕这个 Z0 设计。
...
\[
R_{driver}+R_{series}\approx50\,\Omega
\]

同样，parallel termination 也应围绕实际 system impedance，而不是见到 transmission line 就接一颗 50 Ω。

进一步见：[02｜为什么 50 Ω 常见，但不是必须](02_传输线与特性阻抗.md#261-先回答最核心的问题一定要-50-ω-吗)。
